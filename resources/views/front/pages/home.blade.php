            ...
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <div class="banner_text">
                        ...
                        <p>With a vision to turn manpower into {{asset('front')}}, Risda IT Institute is ready to enhance your learning experience with skilled mentors and updated curriculum. Pick your desired course from more than 30 trendy options.</p>
            ...
            <div class="row">
                <div class="col-12 d-none d-sm-block">
                    <div class="story_text_slider">
                        ...
                        <div class="counte_item counte_item3">
                            <h4>60000+</h4>
                            <h3>Students Choose Risda IT</h3>
                            <p><p><span style="background-color: transparent; color: rgb(0, 0, 0);">Risda IT has become a trusted training institute for not only Bangladeshi residents but also living abroad. More than 60,000 passionate learners are working in different markets after completing courses from our institute.</span></p></p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="free_seminar_img">
                        <img class="img-fluid w-100 sal-animate" src="{{asset('uploads')}}/images/home/seminar_default.jpg" alt="Risda IT Institute" data-sal="slide-right" data-sal-delay="600" data-sal-duration="1000" data-sal-easing="ease">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 offset-lg-1 col-md-6">
                    <div class="practical_project_text sal-animate" data-sal="slide-up" data-sal-delay="500" data-sal-duration="800" data-sal-easing="ease">
                        ...
                        <div>
                            <p>We believe in skills gained through practical projects. A great number of people struggle to start their career in the tech field for only having conceptual knowledge. Risda IT makes sure to provide hands-on training to prepare you for job markets. Our course module contains projects that are designed to track your progress. During the course, you will be able to make a portfolio yourself to showcase your practical skills to the potential employers.</p>
                        </div>
                    </div>
                </div>
            </div>
